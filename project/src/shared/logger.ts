...
const resourceLogLevel = typeof GetConvar === "function" ? GetConvar(`${GetCurrentResourceName()}_logLevel`, "") : "";

let logLevel = typeof GetConvar === "function" ? GetConvar("sv_loglevel", "warning") : "warning";

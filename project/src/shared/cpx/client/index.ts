...
export const Zones = {
    ...
    addPolyZone: (pId: string, pZone: string, pVectors: Vector3Type, pOptions: any, pData = {}) => {
        return CPX.Zones.addPolyZone(pId, pZone, pVectors, pOptions, pData);
    },
    ...
    addCircleZone: (pId: string, pZone: string, pCenter: Vector3Type, pRadius: number, pOptions: any, pData = {}) => {
        return CPX.Zones.addCircleZone(pId, pZone, pCenter, pRadius, pOptions, pData);
    },
    addCircleTarget: (pId: string, pZone: string, pCenter: Vector3Type, pRadius: number, pOptions: any, pData = {}) => {
        return CPX.Zones.addCircleTarget(pId, pZone, pCenter, pRadius, pOptions, pData);
    },
    addEntityZone: (pId: string, pZone: string, pEntity: number, pOptions: any, pData = {}) => {
        return CPX.Zones.addEntityZone(pId, pZone, pEntity, pOptions, pData);
    },
    removeZone: (pZone: string, pId: string) => {
        return CPX.Zones.removeZone(pZone, pId);
    }
}
